...
public class Juridiction {
	...
	public Juridiction(Long idJuridiction, String nom, String telephone, String fax, String email, String adresse, String adresseComplement,
	...
	public String toString() {
		return "Juridiction [idJuridiction=" + idJuridiction + ", nom=" + nom + ", telephone=" + telephone + ", fax="

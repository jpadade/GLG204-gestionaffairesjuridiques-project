...
public class ClientDTO {
	...
	public ClientDTO(Long idClient, String civilite, String nom, String prenom, String dateDeNaissance,
	...
	public String toString() {
		return "ClientDTO [idClient=" + idClient + ", civilite=" + civilite + ", nom=" + nom + ", prenom=" + prenom
